...
public class Output {
    ...
    public static void incrementalWriteRawLog(int step, ArrayList<Transaction> transactions) {
        String rawLogHeader = "step,action,amount,nameOrig,oldBalanceOrig,newBalanceOrig,nameDest,oldBalanceDest,newBalanceDest,isFraud,isFlaggedFraud,isUnauthorizedOverdraft,ipAddress,deviceType,browser,country,geoLocation,sessionId,loginTime,accountType,kycLevel,bank,fraudScenario,aiAlert,externalBlacklist";
        try {
